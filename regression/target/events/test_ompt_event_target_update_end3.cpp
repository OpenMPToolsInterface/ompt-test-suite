...
void update_end_test() {
    ...
    CHECK(number_begin_events == 1, IMPLEMENTED_BUT_INCORRECT, "copy array from host to device: number of update_begin events not as expected (expected %d, observed %d)", 1, number_begin_events);
